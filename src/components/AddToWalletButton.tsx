...
export default function AddToWalletButton({
      ...
      const wasAdded = await window.ethereum.request({
        ...
        params: {
          ...
          options: {
            ...
            symbol: tokenSymbol.slice(0, 11), // MetaMask limits symbol to 11 chars
  ...
  // Don't render if MetaMask is not installed
  if (!hasMetaMask) {
    return null;
  }
  ...
  return (
    <Tooltip
      title={added ? "Added!" : "Add to MetaMask"}
      placement="top"
    >
      <button
        ...
        onMouseEnter={(e) => {
          if (!isAdding && !added) {
            ...
            e.currentTarget.style.background = "rgba(0, 239, 139, 0.1)";
          }
        }}
        onMouseLeave={(e) => {
          if (!added) {
        ...
        {added ? (
          ...
          >
            ...
            <polygon
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              points="103.6,138.2 87.8,162.1 143.8,164.6 141.7,104.1"
            />
            <polygon
              fill="#E4761B"
              stroke="#E4761B"
            ...
            <polygon
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              points="110.6,185.2 130.6,176.1 138.8,193.5 143.8,164.6 87.8,162.1"
            />
            <polygon
              fill="#E4751F"
              stroke="#E4751F"
            ...
            <polygon
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              points="143.8,164.6 138.8,193.5 145.1,227.6 146.6,182.6"
            />
            <polygon
              fill="#E4751F"
              stroke="#E4751F"
              strokeLinecap="round"
              strokeLinejoin="round"
              points="174.6,164.6 172.1,182.5 173.4,227.6 179.8,193.5"
            />
            <polygon
              fill="#F6851B"
              stroke="#F6851B"
              strokeLinecap="round"
              strokeLinejoin="round"
              points="179.8,193.5 173.4,227.6 177.9,230.9 207.1,208.1 208.1,185.2"
            />
            <polygon
              fill="#F6851B"
              stroke="#F6851B"
              strokeLinecap="round"
              strokeLinejoin="round"
              points="110.6,185.2 111.4,208.1 140.6,230.9 145.1,227.6 138.8,193.5"
            />
            <polygon
              fill="#C0AD9E"
              stroke="#C0AD9E"
            ...
            <polygon
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              points="177.9,230.9 173.4,227.6 145.1,227.6 140.6,230.9 138.1,253 140.4,250.8 178.1,250.8 180.6,253"
            />
            <polygon
              fill="#763D16"
              stroke="#763D16"
            ...
            <polygon
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              points="174.6,164.6 177.9,106.9 193.1,65.8 125.6,65.8 140.6,106.9 143.8,164.6 145,182.6 145.1,227.6 173.4,227.6 173.6,182.6"
            />
          </svg>
        )}
      </button>
