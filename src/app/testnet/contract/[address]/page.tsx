...
import ContractContent from "@/app/contract/[address]/ContractContent";

export const revalidate = 30;

export default async function TestnetContractPage({ params }: { params: Promise<{ address: string }> }) {
  ...
  // Note: checkVerification is mainnet-only for now
  ...
  // Note: getVerifiedSources is mainnet-only for now
