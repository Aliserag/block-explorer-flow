...
export default async function BlockDetailPage({ params }: { params: Promise<{ number: string }> }) {
  ...
  const [block, latestBlockNumber] = await Promise.all([
    getBlock(blockNum, "mainnet", true),
  ...
  return (
    <div className="container">
      ...
      {/* Block Jump Input */}
      <BlockJumpInput currentBlock={currentBlockNum} latestBlock={latestNum} />
